      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Logged In successfulyy');
...
var stripe_public_key = 'pk_test_51OrMUhSF1M9EYCramD0SIFaLAg9GEBCw9OvnJQuW19NRAtl3EhT3FuBiQ2TbFC0tEkVWWnNGLjj2DW3LF5xO4TLw00MuQk9Jqb';
...
function loadEvents() {
  ...
  if (userDataForm) {
    userDataForm.addEventListener('submit', function (e) {
      e.preventDefault();
      var form = new FormData(); //creating multipar form data
    ...
    function () {
      ...
      _regeneratorRuntime().mark(function _callee(e) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); //update password takes time due to encryption so we will show updating unless it is finished
            ...
            case 7:
              //after update
              document.querySelector('.btn--save-password').textContent = 'SAVE PASSWORD'; //clearing the filed after password changes
